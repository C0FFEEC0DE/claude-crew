...
### Changed
- `PermissionDenied` retry behavior now disables retries in CI and benchmark headless runs so denied shell commands do not consume turn budget in non-interactive sessions
